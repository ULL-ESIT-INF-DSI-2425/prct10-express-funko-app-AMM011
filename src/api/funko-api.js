...
var UserFunkoManager_js_1 = require("../storage/UserFunkoManager.js");
...
app.get('/funkos', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, manager, funkos;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                manager = new UserFunkoManager_js_1.UserFunkoManager(username);
